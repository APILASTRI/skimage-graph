...
class Graph(object):
    def __init__(self,arr):
        ...
        self.indices = np.zeros((arr.indices.shape[0]*2,),dtype = arr.indices.dtype)
        self.indptr = np.zeros((arr.indptr.shape[0]*2,),dtype = arr.indptr.dtype)
    ...
    def double(self):
        new_indices = np.zeros((self.indices.shape[0]*2,),dtype = self.indices.dtype)
